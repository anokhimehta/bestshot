...
# This config simulates 100 concurrent users uploading 20 images each (total 2000 requests) to test the untrained model's performance on CPU with batching.
